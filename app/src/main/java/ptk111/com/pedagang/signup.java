...
public class signup extends AppCompatActivity {
    ...
    private String[] listDagang = new String[100];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new signup.AmbilData().execute( "http://agungcahya.esy.es/server.php?operasi=viewPedagang" );
    ...
    private class AmbilData extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String result) {
            parseDataPedagang(result);
        }
    }


    private void parseDataPedagang(String hasil){
        int id;
        double latitude, longitude;
        String name, username, password, telepon, dagang;
        iJumlah = 1;
        try {
            ...
            for (int i = 0; i < arrayUser.length(); i++) {
                ...
                dagang = jsonChildNode.optString("dagang");
